...
<head>
    <meta charset="UTF-8">
    <title>{{\App\Settings::first()->name}} - تسجيل الدخول</title>

    <meta http-equiv="X-UA-Compatible" content=="IE=edge" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <link rel="shortcut icon" href="{{asset(\App\Settings::first()->img)}}" type="image/x-icon">
...
<div class="ks-page">
    ...
    <div class="ks-body">
        ...
        <img class="gym_logo" src="@if(\App\Settings::first()->img!=null){{asset(\App\Settings::first()->img)}} @else {{asset('uploads/logo/logo-defult.png')}} @endif">
